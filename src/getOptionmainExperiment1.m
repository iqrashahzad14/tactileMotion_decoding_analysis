...
function opt = getOptionmainExperiment1()
    %
 ...
 if nargin < 1
  ...
  % suject to run in each group
      opt.subjects = {'001', '002'};%, '004', '005', '006', '007', '008', '009', ...
  ...
  % task to analyze
  opt.taskName = 'mainExperiment1'; % auditoryLocalizer
  ...
  % specify the model file that contains the contrasts to compute
    ...
    opt.model.file =  ...
        fullfile(fileparts(mfilename('fullpath')), '..', ...
                 'model', 'model-mainExperiment1_smdl.json');
